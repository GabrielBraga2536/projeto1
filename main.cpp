...
int main() {
    ...
    // Todos atuadores podem ser conectados ou desconectados (um aparelho desligado não pode ser ligado nem receber um valor) (vai precisar ligar novamente e colocar novamente um valor para ele começar a atuar)
    // Todos atuadores podem ser ligados ou desligaods (um aparelho desligado não pode receber um valor) (vai precisar colocar novamente um valor para ele começar a atuar)
